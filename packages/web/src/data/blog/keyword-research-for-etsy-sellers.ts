...
export const post: BlogPost = {
  slug: 'keyword-research-for-etsy-sellers',
  title: 'Keyword Research for Etsy Sellers: Find What Buyers Are Searching For',
  description: 'Learn how to find the best keywords for your Etsy listings. Drive more traffic and sales with data-driven keyword research.',
  date: '2026-04-02',
...
1. Etsy gives more weight to words at the beginning of the title
2. Only the first 40-50 characters show in search results on most devices
3. Buyers scan, they do not read — the first few words determine whether they click
