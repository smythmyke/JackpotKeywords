...
export const post: BlogPost = {
  slug: 'keyword-research-for-saas',
  title: 'Keyword Research for SaaS: How to Find Keywords That Drive Signups',
  description: 'Keyword research strategies specifically for SaaS companies. Find the keywords that convert to trials, signups, and paying customers.',
  date: '2026-04-02',
