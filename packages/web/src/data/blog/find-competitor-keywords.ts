...
export const post: BlogPost = {
  slug: 'find-competitor-keywords',
  title: 'How to Find Keywords Your Competitors Rank For',
  description: 'Discover the exact keywords driving traffic to your competitors — and find gaps they are missing that you can target.',
  date: '2026-04-02',
