...
- **`RAPIDAPI-REPLICATION-RUNBOOK.md`** — **Portable** copy-and-adapt guide distilled from the JK pilot (shipped 2026-05-30): current Studio UI navigation (docs are stale), the 4-move backend shim, testing steps, and the gotchas list. Copy into GovToolsPro / patent-search to replicate.
